<div class="editor-topbar">
        ...
        <div id="toolbar">
            ...
            <span class="ql-formats" title="pouet">
                <button type="button" class="ql-header" value="2"
                    title="{{ __("laravel-blog::post.topbar.header") }}"></button>
                <button type="button" class="ql-header" value="3"
                    title="{{ __("laravel-blog::post.topbar.header") }}">@include('laravel-blog::svg.quill.header-3')</button>
                <button type="button" class="ql-header" value="4"
                    title="{{ __("laravel-blog::post.topbar.header") }}">@include('laravel-blog::svg.quill.header-4')</button>
                <button type="button" class="ql-header" value="5"
                    title="{{ __("laravel-blog::post.topbar.header") }}">@include('laravel-blog::svg.quill.header-5')</button>
                <button type="button" class="ql-blockquote"
                    title="{{ __("laravel-blog::post.topbar.quote") }}"></button>
            </span>
            <span class="ql-formats" title="pouet">
                <button class="ql-list" value="ordered" type="button"
                    title="{{ __("laravel-blog::post.topbar.list.ordered") }}"></button>
                <button class="ql-list" value="bullet" type="button"
                    title="{{ __("laravel-blog::post.topbar.list.bullet") }}"></button>
    ...
    <div class="editor-topbar__actions">
        ...
        <button title="{{ __("laravel-blog::post.topbar.settings") }}" class="editor-sidebarBtn"
            data-sidebar="triggerMeta">
